 ...
 * @return void
 */
void rtnl_link_bond_set_miimon (struct rtnl_link *link, int miimon)
{
	struct bond_info *bn = link->l_info;
 ...
 * @arg link            Link object of type bond
 * @arg links           Number of links
 *
 * @return void
 */
void rtnl_link_bond_set_min_links (struct rtnl_link *link, int links)
{
	struct bond_info *bn = link->l_info;
